...
//                                    print("uh", self.currentAnimating, transitionTime)
                ...
                VStack {
                    ...
                    Text("Distance")
                        ...
                        .underline()
                    Text("\(UnitFormatter1.distanceString(distance: self.tracker.distance, unit: self.distanceUnits))")
                        .font(.system(size: 24, design: .monospaced))
                    Spacer(minLength: 10)
                    Text("Time")
                        .font(.system(size: 24, design: .monospaced))
                        .underline()
                    Text("\(UnitFormatter1.secondsToTraditionalFormatString(seconds: self.tracker.secondsElapsed))")
                        .font(.system(size: 24, design: .monospaced))
